	...
	return (
		<div className="min-h-screen bg-gray-900 text-white p-4 md:p-8">
			...
			<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
				...
				{/* Contact Information */}
				<motion.div
					className="bg-gray-800 p-4 md:p-6 rounded-lg shadow-lg space-y-4"
					initial={{ opacity: 0, x: 20 }}
					animate={{ opacity: 1, x: 0 }}
					transition={{ duration: 0.8 }}
				>
					...
					<div className="flex items-center space-x-4">
						...
						<div>
							<p className="text-sm md:text-base text-gray-300">Email</p>
							<p className="text-sm md:text-base text-white">
								support@chainmove.com
							</p>
						</div>
					</div>
					<div className="flex items-center space-x-4">
						...
						<div>
							<p className="text-sm md:text-base text-gray-300">Phone</p>
							<p className="text-sm md:text-base text-white">
								+1 (234) 567-8901
							</p>
						</div>
					...
					<div className="flex items-center space-x-4">
						...
						<div>
							<p className="text-sm md:text-base text-gray-300">Address</p>
							<p className="text-sm md:text-base text-white">
