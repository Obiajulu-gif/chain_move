				...
				<div className="grid grid-cols-1 md:grid-cols-3 gap-8">
					...
					>
						...
						<p className="text-gray-300 mb-6">
							ChainMove transformed how I manage my transactions. It's fast,
					...
					>
						<FaQuoteLeft className="text-white text-3xl mb-4" />
						<p className="text-gray-300 mb-6">
							The level of convenience ChainMove offers is unmatched. I can
							handle payments and savings in one place!
						</p>
						<div className="flex items-center space-x-4">
							<Image
					...
					>
						<FaQuoteLeft className="text-white text-3xl mb-4" />
						<p className="text-gray-300 mb-6">
							With ChainMove, I never worry about delays or errors in
							transactions. It’s a lifesaver!
						</p>
						<div className="flex items-center space-x-4">
							<Image
								src="/images/vee.jpeg"
