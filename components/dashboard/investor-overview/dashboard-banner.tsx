        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex min-w-0 items-center gap-3 md:gap-4">
            ...
            <div className="min-w-0">
              <p className="text-lg font-semibold leading-none text-foreground md:text-xl">Connect Your Crypto Wallet</p>
          ...
          <button
            type="button"
            onClick={onAction}
            className="inline-flex w-full shrink-0 items-center justify-center gap-1 text-sm font-medium text-blue-700 hover:text-blue-800 dark:text-blue-300 dark:hover:text-blue-200 sm:w-auto"
          >
            Connect Wallet
    ...
    <section className="rounded-xl border border-red-200 bg-red-50 px-4 py-3 dark:border-red-900 dark:bg-red-950/30 md:px-5 md:py-4">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex min-w-0 items-center gap-3 md:gap-4">
          ...
          <div className="min-w-0">
            <p className="text-lg font-semibold leading-none text-foreground md:text-xl">Update your KYC Information</p>
        ...
        <button
          type="button"
          onClick={onAction}
          className="inline-flex w-full shrink-0 items-center justify-center gap-1 text-sm font-medium text-red-700 hover:text-red-800 dark:text-red-300 dark:hover:text-red-200 sm:w-auto"
        >
