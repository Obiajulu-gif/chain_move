			...
			<Container>
				<div className="flex h-24 items-center justify-between">
					<Link href="/investor" className="flex items-center gap-3">
						...
						<span className="text-xl font-semibold leading-none text-cm-orange sm:text-[26px]">
							Chain<span className="text-cm-text">Move</span>
						</span>
					</Link>
							...
							return (
								<Link
									...
									className={cn(
										...
										active
											? "text-cm-orange"
											: "text-white/85 hover:text-cm-text",
									)}
								>
									{link.label}
								</Link>
