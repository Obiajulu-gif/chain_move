...
export function CTASection() {
  return (
    <section className="py-16 text-center bg-white dark:bg-[#18181B]">
      <h2 className="text-3xl font-bold text-[#142841] dark:text-white mb-4">Join the Revolution 🚀</h2>
      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-center">
        <Button size="lg" className="bg-[#E57700] dark:bg-[#FFD580] hover:bg-[#E57700]/90 dark:hover:bg-[#FFD580]/90 text-white dark:text-[#142841]" asChild>
          <Link href="/auth?role=driver">
            Apply for Financing <ArrowRight className="ml-2 h-5 w-5" />
          </Link>
        </Button>
        <Button size="lg" variant="outline" className="border-gray-200 dark:border-gray-700 text-[#142841] dark:text-white" asChild>
