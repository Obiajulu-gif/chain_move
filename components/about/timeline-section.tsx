              ...
              <div key={index} className="relative flex items-start">
                ...
                <div className="ml-6">
                  <div className="flex items-center mb-2">
                    <Badge className="bg-[#142841] dark:bg-[#FFD580] text-white dark:text-[#142841] mr-3">{milestone.year}</Badge>
                    <h3 className="text-lg font-semibold text-[#142841] dark:text-white">{milestone.title}</h3>
                  </div>
