		...
		<Card className="bg-card dark:bg-[#23232A] border-border">
			<CardHeader>
				...
				<CardDescription className="text-muted-foreground dark:text-gray-300">
					High-demand vehicles with excellent ROI potential and proven track
					records
				</CardDescription>
			</CardHeader>
			<CardContent>
				<div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
					{featuredVehicles.map((vehicle) => (
						<Card
							key={vehicle.id}
							className="bg-muted dark:bg-[#18181B] border-border hover:border-[#E57700] transition-colors"
						>
							<div className="relative">
								...
								<div className="absolute top-3 right-3 flex flex-col space-y-1">
									...
									<Badge className="bg-[#E57700] text-white text-xs">
										{vehicle.roi}% ROI
									</Badge>
								</div>
								<Button
