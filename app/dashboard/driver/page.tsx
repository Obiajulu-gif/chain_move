  ...
  const handleApplyForLoanClick = () => {
    ...
    if (kycStatus === "approved_stage2") {
      ...
      if (kycStatus === "none") {
        ...
        setKycPromptMessage(
          "Your KYC verification was rejected. Please review the requirements and re-submit.",
        )
        setKycPromptAction({ label: "Re-submit KYC", href: "/dashboard/driver/kyc" })
      } else if (physicalMeetingStatus === "rejected_stage2") {
        setKycPromptMessage(
          "Your second stage KYC (physical meeting) was rejected. Please review the requirements and re-submit.",
        )
        setKycPromptAction({ label: "Review alerts", href: "/dashboard/driver/notifications" })
      }
    }
  }
