          ...
          <div className="mb-6 sm:mb-8">
            <div className="grid sm:grid-cols-2 gap-4 sm:gap-8 items-center">
              ...
              <div className="space-y-4 sm:space-y-6">
                <div>
                  <h1 className="text-2xl sm:text-3xl font-bold text-foreground mb-3 sm:mb-4">Governance Tokens</h1>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-6 sm:mb-8">
            <Card className="bg-card/50 hover:bg-card/70 transition-all duration-200 border-border/50">
              ...
              <CardContent className="p-4">
                ...
                <p className="text-xs text-muted-foreground">CHMV Tokens</p>
              </CardContent>
            </Card>

            <Card className="bg-card/50 hover:bg-card/70 transition-all duration-200 border-border/50">
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium text-muted-foreground">Staked Tokens</CardTitle>
                <Wallet className="h-4 w-4 text-foreground" />
              </CardHeader>
              <CardContent className="p-4">
                <div className="text-2xl font-bold text-foreground">{stakedTokens.toLocaleString()}</div>
                <p className="text-xs text-muted-foreground">{((stakedTokens / totalTokens) * 100).toFixed(1)}% staked</p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-card/50 hover:bg-card/70 transition-all duration-200 border-border/50">
              ...
              <CardContent className="p-4">
                <div className="text-2xl font-bold text-foreground">{availableTokens.toLocaleString()}</div>
            ...
            <Card className="bg-card/50 hover:bg-card/70 transition-all duration-200 border-border/50">
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium text-muted-foreground">Voting Power</CardTitle>
                <Gift className="h-4 w-4 text-foreground" />
              </CardHeader>
              <CardContent className="p-4">
                <div className="text-2xl font-bold text-foreground">{votingPower.toFixed(1)}%</div>
